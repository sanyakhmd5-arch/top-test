...
import { hospitalityGalleryImages } from "@/data/services-gallery";
import {
  Wine,
  CheckCircle2,
  ArrowLeft,
...
export default function HospitalityPage() {
  ...
  const service = services.find((s) => s.id === "hospitality")!;
            ...
            <AnimateOnScroll>
              <div className="premium-card rounded-2xl p-6 md:p-10">
                <div className="w-16 h-16 rounded-2xl bg-brand/10 dark:bg-primary/10 flex items-center justify-center mb-6">
                  <Wine className="text-brand dark:text-primary" size={32} />
                </div>
      ...
      <section className="section-premium">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <CanteensGallery images={hospitalityGalleryImages} lang={lang} />
          </div>
        </div>
      </section>
            ...
            <AnimateOnScroll>
              <div className="premium-card card-glow rounded-2xl p-8 md:p-12">
                <div className="w-16 h-16 rounded-full bg-brand/10 dark:bg-primary/10 flex items-center justify-center mx-auto mb-6">
                  <Wine className="text-brand dark:text-primary" size={28} />
                </div>
