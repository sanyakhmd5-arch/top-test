...
import { CanteensGallery, type CanteenGalleryImage } from "@/components/ui/canteens-gallery";

// Canteens "معرض الأعمال" images — original uploads, served at full quality.
const canteensGalleryImages: CanteenGalleryImage[] = [
  {
    src: "/images/canteens/canteen-1.jpg",
    alt: "TOP TEST - مقصف مدرسي - صورة 1",
    captionAr: "من أعمال المقاصف المدرسية المنفذة",
    captionEn: "One of our completed school canteen projects",
    width: 1600,
    height: 900,
  },
  {
    src: "/images/canteens/canteen-2.jpg",
    alt: "TOP TEST - مقصف مدرسي - صورة 2",
    captionAr: "من أعمال المقاصف المدرسية المنفذة",
    captionEn: "One of our completed school canteen projects",
    width: 1536,
    height: 1024,
  ...
  {
    src: "/images/canteens/canteen-3.jpg",
    alt: "TOP TEST - مقصف مدرسي - صورة 3",
    captionAr: "من أعمال المقاصف المدرسية المنفذة",
    captionEn: "One of our completed school canteen projects",
    width: 1536,
    height: 1024,
  ...
  {
    src: "/images/canteens/canteen-4.jpg",
    alt: "TOP TEST - مقصف مدرسي - صورة 4",
    captionAr: "من أعمال المقاصف المدرسية المنفذة",
    captionEn: "One of our completed school canteen projects",
    width: 1536,
    height: 1024,
  ...
  {
    src: "/images/canteens/canteen-5.jpg",
    alt: "TOP TEST - مقصف مدرسي - صورة 5",
    captionAr: "من أعمال المقاصف المدرسية المنفذة",
    captionEn: "One of our completed school canteen projects",
    width: 1600,
    height: 900,
  ...
  {
    src: "/images/canteens/canteen-6.jpg",
    alt: "TOP TEST - مقصف مدرسي - صورة 6",
    captionAr: "من أعمال المقاصف المدرسية المنفذة",
    captionEn: "One of our completed school canteen projects",
    width: 1402,
    height: 1122,
...
export default function SchoolCanteensPage() {
  const { lang, t, dir } = useI18n();
  const BackArrow = dir === "rtl" ? ArrowLeft : ArrowRight;

  const service = services.find((s) => s.id === "school-catering")!;
            ...
            <AnimateOnScroll>
              <div className="premium-card rounded-2xl p-6 md:p-10">
                <div className="w-16 h-16 rounded-2xl bg-brand/10 dark:bg-primary/10 flex items-center justify-center mb-6">
                  <UtensilsCrossed className="text-brand dark:text-primary" size={32} />
                </div>
      ...
      <section className="section-premium">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <CanteensGallery images={canteensGalleryImages} lang={lang} />
          </div>
        </div>
      </section>
            ...
            <AnimateOnScroll>
              <div className="premium-card card-glow rounded-2xl p-8 md:p-12">
                <div className="w-16 h-16 rounded-full bg-brand/10 dark:bg-primary/10 flex items-center justify-center mx-auto mb-6">
                  <UtensilsCrossed className="text-brand dark:text-primary" size={28} />
                </div>
                ...
                <Link href="/contact">
                  <Button
                    size="lg"
                    className="bg-brand hover:bg-brand-light dark:bg-primary dark:hover:bg-primary/90 text-white rounded-full px-8 btn-text-sm"
                  >
                    {t.contact.title}
