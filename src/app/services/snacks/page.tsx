...
import { snacksGalleryImages } from "@/data/services-gallery";
import {
  Cookie,
  CheckCircle2,
  ArrowLeft,
...
const placeholderData = {
  ...
  titleEn: "Snacks",
  descriptionAr:
    "تشكيلة متميزة من الوجبات الخفيفة الصحية والشهية صُممت لتناسب جميع الأوقات والمناسبات. نجمع بين المذاق الرائع والقيمة الغذائية العالية في كل قضمة، مع خيارات خفيفة ومتوازنة تعكس التزامنا بالجودة والتنوع.",
  descriptionEn:
    "A distinguished selection of healthy and delicious snacks designed for all times and occasions. We combine great taste with high nutritional value in every bite, with light and balanced options that reflect our commitment to quality and variety.",
  featuresAr: [
    "وجبات خفيفة صحية متوازنة بعناية",
    "تشكيلة سندويشات متنوعة ولذيذة",
    "معجنات طازجة تُخبز يومياً",
    "خيارات مدروسة تناسب جميع الأعمار",
    "تغليف نظيف ومريح يليق بالاحترافية",
    "مكونات طازجة بجودة لا تقبل المساومة",
  ],
  featuresEn: [
    "Carefully balanced healthy snacks",
    "Diverse and delicious sandwich selection",
    "Fresh pastries baked daily",
    "Thoughtful options suitable for all ages",
    "Clean and convenient packaging befitting professionalism",
    "Fresh ingredients with uncompromising quality",
  ],
};
  ...
  return (
    <>
      <PremiumPageHero
        ...
        backgroundImage="/images/hero/snacks.webp"
        personality="snacks"
      />
            ...
            <AnimateOnScroll>
              <div className="premium-card rounded-2xl p-6 md:p-10">
                <div className="w-16 h-16 rounded-2xl bg-brand/10 dark:bg-primary/10 flex items-center justify-center mb-6">
                  <Cookie className="text-brand dark:text-primary" size={32} />
                </div>
      ...
      <section className="section-premium">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <CanteensGallery images={snacksGalleryImages} lang={lang} />
          </div>
        </div>
      </section>
            ...
            <AnimateOnScroll>
              <div className="premium-card card-glow rounded-2xl p-8 md:p-12">
                <div className="w-16 h-16 rounded-full bg-brand/10 dark:bg-primary/10 flex items-center justify-center mx-auto mb-6">
                  <Cookie className="text-brand dark:text-primary" size={28} />
                </div>
